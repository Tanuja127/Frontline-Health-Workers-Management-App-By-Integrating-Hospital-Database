...
move = sqlite3.connect('database.db')
...
class Application:
    def __init__(self, master):
        ...
        self.left = Frame(master, width=750, height=720, bg='lavender')
        self.left.pack(side=LEFT)

        self.right = Frame(master, width=500, height=720, bg='black')
        self.right.pack(side=RIGHT)

        # labels for the window
        self.heading = Label(self.left, text="COVID HEALTHCARE", font=('arial 40 bold'), fg='lavender', bg='black')
        self.heading.place(x=100, y=0)
        # patients name
        self.name = Label(self.left, text="Patient's Name", font=('arial 18 bold'), fg='black', bg='lavender')
        self.name.place(x=0, y=100)

        # age
        self.age = Label(self.left, text="Age", font=('arial 18 bold'), fg='black', bg='lavender')
        self.age.place(x=0, y=140)

        # gender
        self.gender = Label(self.left, text="Gender", font=('arial 18 bold'), fg='black', bg='lavender')
        self.gender.place(x=0, y=180)

        # location
        self.location = Label(self.left, text="Location", font=('arial 18 bold'), fg='black', bg='lavender')
        self.location.place(x=0, y=220)

        # phone
        self.phone = Label(self.left, text="Phone Number", font=('arial 18 bold'), fg='black', bg='lavender')
        self.phone.place(x=0, y=260)

        # appointment time
        self.time = Label(self.left, text="Appointment Date", font=('arial 18 bold'), fg='black', bg='lavender')
    ...
    def add_appointment(self):
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '':
            ...
            sql = "INSERT INTO 'appointments' (name, age, gender, location, phone, appointment_date) VALUES(?, ?, ?, ?, ?, ?)"
